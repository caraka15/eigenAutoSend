...
// Alamat tujuan untuk transfer token
const DESTINATION_ADDRESS = "0x0000009E580508987e629a93C8b2F11396DAdEa7";
// Threshold balance ETH untuk melakukan transfer (dalam ETH)
const ETH_THRESHOLD = "0.001";
// Jumlah token yang akan ditransfer
...
const abi = [
  {
    inputs: [
      { internalType: "contract IERC20", name: "_bEIGEN", type: "address" },
    ],
